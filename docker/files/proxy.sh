...
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# Update this proxy configuration if you are behind a proxy server
#-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# export http_proxy='http://your_proxy_here:3128'
# export https_proxy="${http_proxy}"
# export no_proxy='localhost,127.0.0.1,your_internal_domain_here.local'
