...
class RuleExample(RuleBase):
    """
    This is an example rule implementation.
    """

    def __init__(self):
        self._rule_name = 'Example Rule'
        super().__init__()
    
    def _should_run(self):
        self._log('Should I run?')
        return True
        
    def _run(self):
        self._log('Running ' + self._rule_name)
        
    def register(self):
        self._log("Registering " + self._rule_name)
